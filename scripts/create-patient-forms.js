const csvFilePath = '../CSV/patient-forms.csv';
...
function createPatientData(element, i) {
    ...
    var dataObj = {};
    dataObj.id = i;
    dataObj.formName=element.formName;
    ...
    dataObj.lastUpdate=element.lastUpdate;
...
csv()
    ...
    .then((jsonObj) => {
        ...
        fs.writeFile('../JSON/patient-forms.json', JSON.stringify(formattedData), 'utf8', function (err) {
            if (err) throw err;
            console.log('Saved!');
        });
    });